...
if decision == "Si":
    ...
    if decision == "No":
        ...
        if decision == "Si":
            time.sleep(1)
            print(
                "Es una princesa, te advierte que no sigas adelante porque había un hueco.")
            time.sleep(1)
            print(" La liberas*")
            time.sleep(2)
            ...
            if decision == "Rodear":
                ...
                if decision == "Descansar":
                    time.sleep(1)
                    print(
                        "Esperan un rato y mientras hablan con la damisela encuentran muchas cosas en común.")
                    time.sleep(2)
                    ...
                    if decision == "Continuar":
                        ...
                        if decision == "Entrar":
                            time.sleep(1)
                            print(
                                "Hay comida, un tesoro, cama, una televisión con Netflix. Tú y la damisela se quedan a vivir allí felizmente.")
                        ...
                        time.sleep(1)
                        print(
                            "Un cazador furtivo los confunde con un leopardo y les dispara. Mueres* \nGame Over")
                    else:
                        print("Escogiste una opción no disponible")
                elif decision == "Seguir":
                    time.sleep(1)
                    print(
                        "Había un tigre depredando en los alrededores y les ataca. \nGame Over.")
                else:
                    print("Escogiste una opción no disponible")
            elif decision == "Nadar":
